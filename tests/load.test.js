...
describe('File: load.js', () => {
  describe('Method: toCSV', () => {
    it('should throw error when the length of data is 0', () => {
      expect(() => load.toCSV([], 'test', 'test', 0)).to.throw('No data was passed into the load method!');
    });
    it('should throw error when file is not a CSV file', () => {
  ...
  describe('Method: toJSON', () => {
    ...
    it('should throw error when file is not a JSON file', () => {
  ...
  describe('Method: toXML', () => {
    ...
    it('should throw error when file is not a XML file', () => {
